...
int main(){
Tree*tree=createTree(5656);
Tree*l1=insertLchild(tree,465665);
Tree*r1=insertRchild(tree,57757);
Tree*r2=insertRchild(l1,4646);
Tree*l2=insertLchild(l1,46464);
Tree*r3=insertRchild(r1,464646);
Tree*l3=insertLchild(r1,57577);
printf("非递归前序遍历如下：\n");
presort(tree);
putchar('\n');
printf("非递归中序遍历如下：\n");
